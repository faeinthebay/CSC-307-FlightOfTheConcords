...
public class EmployeeSchedulerController {
	...
	public void HandleBusinessRulesButtonClick(ActionEvent event) throws Exception{
		Pane rules = FXMLLoader.load(getClass().getResource("../view/employee_scheduler_business_rules.fxml"));
		Stage stage = new Stage();
